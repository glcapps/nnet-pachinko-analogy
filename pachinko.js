...
function runPachinko() {
    ...
    function displayPachinko() {
        ...
        makeQuickNumberedArray(10).forEach(bucketNumber => {
            ...
            bucket.attr({ fill: '#2CB01A' });
            bucketGroup.append(bucket);
            // Text path usage
            let textLabel = myPaper.text(1, 22, 'b');

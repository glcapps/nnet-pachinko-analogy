...
function runPachinko() {
    ...
    function displayPachinko() {
        ...
        let raohaelFlagPath = "M9.5,3v10c8,0,8,4,16,4V7C17.5,7,17.5,3,9.5,3z M6.5,29h2V3h-2V29z";
        ...
        makeQuickNumberedArray(10).forEach(x => {
            makeQuickNumberedArray(10).forEach(y => {
                processPeg(Math.random(), (Math.random()*0.5)+0.25, 'diamond', x, y);
            });
        });
        ...
        makeQuickNumberedArray(11).forEach(bucketNumber => {
            ...
            bucketGroup.transform('scale(0.00546,-0.009100) translate('+(900+(bucketNumber*10000))+',-70000)');
        });
    } // displayGraph
    displayPachinko();
}
